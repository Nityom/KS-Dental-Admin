...
function generatePDF(doc: jsPDF, billData: BillData): void {
  ...
  doc.setFontSize(18);
  centerText('Shahi Dental & Aesthetics', yPos, 18);
  yPos += 7;
  ...
  doc.setFontSize(9);
  doc.setFont('helvetica', 'normal');
  centerText('Thank you for choosing Shahi Dental & Aesthetics for your dental care needs.', yPos, 9);
  yPos += 5;
